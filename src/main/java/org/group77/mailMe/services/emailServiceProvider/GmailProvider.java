...
public class GmailProvider extends EmailServiceProviderStrategy {
    ...
    @Override
    protected List<org.group77.mailMe.model.Folder> parse(Store store, int numFirstMsg, int numLastMsg) throws MessagingException {
        ...
        List<org.group77.mailMe.model.Folder> folders = new ArrayList<>();
        ...
        for (Map.Entry<String, javax.mail.Folder> entry : map.entrySet()) {
            ...
            folders.add(new org.group77.mailMe.model.Folder(name, emails));
        }
        return folders;
    }
